...
# Test specifically for white_pieces pointer
print(len(b_test.white_pieces))
print('Queen is on row:', b_test.white_pieces[0].row, 'and col:', b_test.white_pieces[0].col)
