...
class Application(tornado.web.Application):
    def __init__(self):
        ...
        handlers = [(r"/[/]?", BaseHandler),
                    ...
                    (r"/TestServerConnection[/]?", skh.TestServerConnection),
                    (r"/SetPlayers[/]?",        skh.SetPlayers)
                    ]
        ...
        self.clf = dict() # the classifier model (in-class assignment, you might need to change this line!)
        # but depending on your implementation, you may not need to change it  ¯\_(ツ)_/¯ yea, okay Eric ¯\_(ツ)_/¯
